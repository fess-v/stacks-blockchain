...
/// This is Epoch-2.4, now Epoch-3.0, activation height proposed in _
pub const BITCOIN_MAINNET_STACKS_30_BURN_HEIGHT: u64 = 800_000;
...
pub const BITCOIN_TESTNET_STACKS_30_BURN_HEIGHT: u64 = 2_532_545;
