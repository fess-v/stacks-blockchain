...
pub fn sign_tx_order_independent_p2sh(
    ...
    let mut sender_spending_condition =
        TransactionSpendingCondition::new_multisig_order_independent_p2sh(num_sigs as u16, pubks.clone())
...
pub fn sign_tx_order_independent_p2wsh(
    ...
    let mut sender_spending_condition =
        TransactionSpendingCondition::new_multisig_order_independent_p2wsh(num_sigs as u16, pubks.clone())
