...
pub mod test {
    ...
    use crate::chainstate::stacks::tests::make_stacks_transfer_order_independent_p2sh;
    use crate::chainstate::stacks::tests::make_stacks_transfer_order_independent_p2wsh;
